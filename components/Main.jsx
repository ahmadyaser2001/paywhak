  ...
  return (
	...
	<div>
      ...
      >
        ...
        <div class="flex flex-col mb-32 space-y-12 md:w-1/2 mt-20">
          <h1
            className="text-white max-w-md text-4xl font-bold text-center md:text-5xl md:text-left"
          >
		<p className='text-2xl text-black opacity-0'>	Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum dolores natus sit, est vero libero</p> 
